...
function EditEmployee(props) {
  ...
  return (
    <>
        <button onClick={handleShow} className="border-purple-200 text-purple-600 hover:border-transparent hover:bg-purple-600 hover:text-white active:bg-purple-700">
      Update
    </button>
  ...
  <div className="md:flex md:items-center mb-6">
    ...
    <div className="md:w-2/3">
      <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="role" type="text" Value={props.role} />
    </div> 
